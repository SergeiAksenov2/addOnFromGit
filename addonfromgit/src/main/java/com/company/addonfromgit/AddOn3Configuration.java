...
@PropertySource(name = "com.company.addonfromgit", value = "classpath:/com/company/addonfromgit/module.properties")
public class AddOn3Configuration {

    @Bean("addOn3_AddOn3ViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.company.addonfromgit"));
        return viewControllers;
    }

    @Bean("addOn3_AddOn3Actions")
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.company.addonfromgit"));
        return actions;
    }
}
